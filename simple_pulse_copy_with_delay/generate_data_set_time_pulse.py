...
def generate_trials(size,mem_gap):
    ...
    for ii in np.arange(sample_size): 
        x_train[ii, first_in+ var_delay[ii]:first_in+ var_delay[ii] + stim_dur, 0]   = xor_seed_A[trial_types[ii], 0]
        ...
        y_train[ii, out_t + var_delay[ii]:out_t+stim_dur+var_delay[ii], 0]  = xor_y[trial_types[ii]]
